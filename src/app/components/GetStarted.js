...
const GetStarted = () => {
  ...
  const Card = ({ item }) => {
    ...
    return (
      <div className="group relative flex h-[180px] w-full items-center justify-center overflow-hidden rounded-2xl bg-[#050E21] p-4 sm:h-[200px] sm:w-[280px] md:h-[200px] md:w-[330px] lg:h-[330px] lg:w-[295px] xl:h-[385px] xl:w-[275px]">
        <div
        ...
        >
          ...
          <div className="relative flex h-full w-full flex-col items-center justify-center rounded-2xl bg-[#050E21] p-3">
            <div className="flex h-[60px] sm:h-[80px] md:h-[90px] lg:h-[110px] items-center">
              <h1 className="mb-2 sm:mb-3 mt-0 w-full text-wrap text-center text-[13px] font-medium tracking-wide md:text-[20px] lg:text-[22px] xl:my-5">
                {item.heading}
              </h1>
            </div>
            <div className={`h-[1.3px] w-full ${item.lineGradient} my-1 sm:my-2`}></div>
            <div className="flex h-[100px] sm:h-[120px] md:h-[150px] lg:h-[200px] items-center">
              <p className="mb-0 mt-2 sm:mt-3 text-center text-[10px] sm:text-[11px] tracking-wider md:text-[13px] lg:text-[14px] xl:my-4">
                {item.paragraph}
              </p>
            </div>
            <div
  ...
  return (
    <div className="w-full relative min-h-[720px] md:min-h-[800px] lg:min-h-[720px] lg:pb-16 overflow-hidden">
      <div className="getstarted-background h-full min-h-[700px] absolute top-[-10%] z-10"></div>
      <div className="bg-gradient-to-b from-[#00061280] to-[#000612] w-full h-full min-h-[700px] absolute top-[-10%] left-0 z-20"></div>
      <h2 className="text-[20px] 4xs:text-[30px] md:text-[40px] bw:text-[50px] font-medium tracking-wide mt-4 pt-3 mb-0 text-center bg-gradient-to-r from-[#999999] via-white to-[#999999] bg-clip-text text-transparent relative z-30">
        Get Started Now
      </h2>
      <div className="flex flex-wrap w-[92%] xl:w-[85%] items-center justify-center gap-3 my-5 sm:my-8 md:my-12 lg:my-16 mx-auto z-30 relative">
