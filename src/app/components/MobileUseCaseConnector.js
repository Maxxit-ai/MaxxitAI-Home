...
const MobileUseCaseConnector = () => {
  return (
    <div className="w-full relative flex flex-col items-center justify-between gap-6">
      {/* line 1 */}
      ...
      {/* circle on left side */}
      <div className="flex items-center justify-center w-[280px] h-[280px] rounded-full bg-[#68E09978] border border-[#DFDFDF] shadow-[inset_0px_0px_48.59px_0.91px_#FFFFFFB2] opacity-50">
        <div className="flex items-center justify-center w-[180px] h-[180px] rounded-full bg-[#AF85E378] border border-[#DFDFDF] shadow-[inset_0px_0px_22.03px_4.53px_#FFFFFFB2] opacity-70">
          <div className="flex items-center justify-center w-[100px] h-[100px] rounded-full bg-[#8B94E2] border border-[#FFFFFF] shadow-[inset_0px_4.53px_21.85px_6.35px_#FFFFFF80] opacity-90">
      ...
      {/* side div1 */}
      <div className="w-[520px] h-[280px] rounded-3xl bg-[#050E21] flex items-center justify-center">
        <div className="w-[480px] h-[240px] rounded-3xl bg-border-gradient1 flex items-center justify-center">
          <div className="w-[478px] h-[238px] rounded-3xl bg-[#050e21] flex flex-col justify-between py-5 px-7">
      ...
      {/* side div2 */}
      <div className="w-[520px] h-[280px] rounded-2xl bg-[#050E21] flex items-center justify-center">
        <div className="w-[480px] h-[240px] rounded-3xl bg-border-gradient2 flex items-center justify-center">
          <div className="w-[478px] h-[238px] rounded-3xl bg-[#050e21] flex flex-col justify-between py-5 px-7">
            <div className="flex items-center relative gap-5">
      ...
      {/* side div3 */}
      <div className="w-[520px] h-[280px] rounded-2xl bg-[#050E21] flex items-center justify-center">
        <div className="w-[480px] h-[240px] rounded-3xl bg-border-gradient3 flex items-center justify-center">
          <div className="w-[478px] h-[238px] rounded-3xl bg-[#050e21] flex flex-col justify-between py-5 px-7">
            <div className="flex items-center relative gap-5">
