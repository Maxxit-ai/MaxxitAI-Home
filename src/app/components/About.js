  ...
  return (
    <div className="w-full overflow-hidden relative">
      ...
      <div className="backdrop-blur-[20px] bg-gradient-to-b from-[#00061266] to-[#000612] flex flex-col items-center my-10">
        <h2 className="text-[50px] font-medium tracking-normal text-center bg-gradient-to-r from-[#999999] via-white to-[#999999] bg-clip-text text-transparent">
          About SmartDisperse
        </h2>
        ...
        <div className="flex w-[85%] items-center justify-center gap-8 my-10">
          {about.map((about, index) => (
            <div
              key={index}
              className={`${about.gradient} p-[1px] flex items-center justify-center rounded-2xl hover:shadow-[0px_0px_30px_10px_#FFFFFF60] hover:p-[0px] hover:translate-y-[-6px] transition-all duration-300`}
            >
