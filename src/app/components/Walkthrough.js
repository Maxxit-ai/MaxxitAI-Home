      ...
      <div className="flex flex-col items-center justify-center z-30 relative">
        ...
        <div className="relative w-full h-[800px] mx-auto">
          ...
          <div>
            ...
            <div className="bg-[#2D164A] px-4 py-3 rounded-md text-white absolute top-[calc(25%-100px)] left-[26.5%]">
              Connect Wallet
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-[#0E3F3F] px-6 py-3 rounded-md text-white absolute top-[calc(36%)] left-[12%]">
              Select Chain
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-[#282C4C] px-4 py-3 rounded-md text-white text-center absolute top-[calc(40%+130px)] left-[calc(40%-90px)]">
              Select Transactions Type<br />(same-chain/cross-chain)
            </div>
          </div>
          ...
          {/* <div>
            ...
            <div className="w-[2px] h-[120px] absolute top-[41%] left-[calc(56%+32px)] bg-[#49494ACC]"></div>
            <div className="bg-[#173A25] px-4 py-3 rounded-md text-white absolute top-[calc(25%-100px)] left-[26.5%]">
